      ...
      {batTrach && (
        <>
          <div className="rounded-2xl bg-white p-6 shadow-sm">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                <div className="font-bold text-gray-800">
                  Cung Mệnh: {batTrach.cungMenh}
                </div>
                <div className="text-sm text-gray-500">
                  {batTrach.nhomMenh === "dong"
                    ? "Đông Tứ Mệnh"
                    : "Tây Tứ Mệnh"}
                </div>
              </div>
            ...
            <h3 className="mb-3 mt-4 font-semibold text-red-700">
              Hướng Xấu (4 hướng cần tránh)
            </h3>
            <div className="space-y-2">
              {batTrach.huongNhaXau.map((h) => (
                ...
                >
                  <span className="text-lg font-bold text-red-600 w-8">
                    {h.direction}
                  </span>
                  <div>
