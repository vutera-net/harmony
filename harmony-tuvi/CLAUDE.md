...
```
/home/linh/Projects/vu/base1/
├─ harmony-tuvi/                    ← Specs & documentation (this repo)
│  ├─ specs.md                      ← Original product strategy
│  ├─ CLAUDE.md                     ← This file
│  └─ docs/
│     ├─ PRD.md                     ← Full PRD
│     └─ IMPLEMENTATION_PLAN.md     ← Checkboxes & phases
│
└─ tuvi/                            ← Actual codebase (Next.js app)
   ├─ src/
...
export const CAN_CHI_YEARS: CanChiYear[] = [ /* 60 entries */ ];
```
...
- **Funnel Components:** `/tuvi/src/components/funnel/`
- **Engines:** `/tuvi/src/lib/engines/`
- **Data:** `/tuvi/src/data/`
- **Codebase:** `/tuvi/`
...
**Status:** Active Development (v2.0 Post-Pivot)
