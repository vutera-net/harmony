  ...
  return (
    <div className="py-6">
      ...
      <div className="flex gap-4 mb-6 flex-wrap text-xs">
        ...
        <div className="flex items-center gap-1.5">
          <div className="w-3 h-3 rounded-sm bg-rose-50 dark:bg-rose-950/30 border border-rose-300 dark:border-rose-800" />
          ...
          {visibleDays.map((d) => {
            ...
            return (
              <div
                ...
                } ${d.isHoangDao ? "bg-amber-50/30 dark:bg-amber-950/10" : d.isHacDao ? "bg-rose-50/30 dark:bg-rose-950/20" : ""} ${
              ...
              >
                ...
                <div className="flex items-center gap-0.5 overflow-hidden">
                  ...
                  {d.isHacDao && !d.isHoangDao && (
                    <div className="flex items-center gap-1 text-[9px] sm:text-[10px] text-rose-500 dark:text-rose-400 font-medium uppercase truncate">
                      <Moon size={9} />
              ...
              <div className="space-y-4">
                ...
                <div className={`flex items-center gap-3 p-4 rounded-2xl ${
                  ...
                  {selectedDay.isHoangDao ? (
                    ...
                    <Moon className="text-rose-500 shrink-0" size={22} />
                  ) : (
                    <Moon className="text-stone-500 shrink-0" size={22} />
                  )}
                  <div>
                    <p className={`font-bold ${selectedDay.isHoangDao ? "text-amber-700 dark:text-amber-400" : selectedDay.isHacDao ? "text-rose-700 dark:text-rose-400" : "text-stone-600 dark:text-stone-300"}`}>
